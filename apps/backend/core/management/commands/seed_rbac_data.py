...
PERMISSION_DEFINITIONS = [
    ...
    ("products", "cost", "View and manage product cost"),
    ...
    ("users", "deactivate", "Deactivate or reactivate user accounts"),
    ("users", "reset_password", "Reset managed user passwords"),
    ("roles", "read", "View roles and permissions"),
    ("roles", "update_permissions", "Update role preset permissions"),
    ("system", "manage_admins", "Manage admin accounts"),
