  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-linear-to-br from-primary via-primary/90 to-primary/70 items-center justify-center">
        ...
        {/* Content */}
        <div className="relative z-10 flex w-full max-w-2xl flex-col items-center px-8 text-center text-white">
          <div className="mb-8 flex justify-center">
            <div className="flex h-80 w-80 items-center justify-center rounded-3xl bg-white/20 p-4 shadow-2xl backdrop-blur-sm">
              <img
                src={RaynLogo}
          ...
          <h1 className="mb-3 w-full whitespace-nowrap text-center text-3xl font-bold leading-tight tracking-tight xl:text-4xl">
            Rayn Motorparts and Accessories
          </h1>
          <p className="mb-6 text-lg leading-relaxed text-white/80">
            Inventory Management System with Integrated Point of Sale System.
          </p>

          <div className="mx-auto h-px w-16 bg-white/30" />

          <p className="mt-6 text-sm text-white/60 leading-relaxed">
            Manage orders, track sales, and keep your motorparts business running smoothly - all
            in one place.
          </p>
        </div>
      </div>
      ...
      <div className="flex w-full flex-col items-center justify-center px-6 py-12 lg:w-1/2">
        <div className="w-full max-w-sm space-y-8">
          ...
          <div className="flex flex-col items-center lg:hidden">
            <div className="mb-4 flex h-24 w-24 items-center justify-center rounded-2xl bg-primary/10 p-2">
              <img
                src={RaynLogo}
                alt="Rayn Motorparts and Accessories"
                className="h-full w-full object-contain"
            ...
            <h1 className="w-full whitespace-nowrap text-center text-xl font-bold leading-tight text-foreground">
              Rayn Motorparts and Accessories
            </h1>
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        type="email"
                        placeholder="you@raynmotorparts.com"
                        autoComplete="email"
          ...
          <p className="text-center text-xs text-muted-foreground/60">
            © {new Date().getFullYear()} Rayn Motorparts and Accessories. All rights reserved.
          </p>
        </div>
      </div>
    </div>
