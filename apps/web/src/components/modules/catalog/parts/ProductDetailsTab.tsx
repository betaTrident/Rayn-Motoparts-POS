  ...
  return (
    <div className="space-y-4 px-4 py-5 sm:px-6">
      <div className="space-y-1.5">
        <Label htmlFor="product-name" className="text-muted-foreground text-xs font-medium">
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        <div className="space-y-1.5">
          <Label htmlFor="product-sku" className="text-muted-foreground text-xs font-medium">SKU</Label>
          <Input
            id="product-sku"
        ...
        <div className="space-y-1.5">
          <Label htmlFor="product-part-number" className="text-muted-foreground text-xs font-medium">Part Number</Label>
          <Input
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        <div className="space-y-1.5">
          ...
          >
            <SelectTrigger className={cn("w-full cursor-pointer", productFormErrors.category && "border-destructive")}>
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        <div className="space-y-1.5">
          <Label htmlFor="product-cost-price" className="text-muted-foreground text-xs font-medium">Cost Price (PHP)</Label>
          <Input
            ...
            onChange={(e) => {
              setProductForm((f) => ({ ...f, cost_price: parseFloat(e.target.value) || 0 }));
        ...
        <div className="space-y-1.5">
          <Label htmlFor="product-selling-price" className="text-muted-foreground text-xs font-medium">
          ...
          <Input
            ...
            onChange={(e) => {
              setProductForm((f) => ({ ...f, selling_price: parseFloat(e.target.value) || 0 }));
      ...
      {productForm.is_taxable ? (
        <div className="space-y-1.5">
          ...
          <Select
            value={productForm.tax_rate ? String(productForm.tax_rate) : ""}
            onValueChange={(val) => {
              setProductForm((f) => ({ ...f, tax_rate: Number(val) }));
              setProductFormErrors((prev) => ({ ...prev, tax_rate: undefined }));
            }}
          >
            <SelectTrigger className={cn("w-full cursor-pointer", productFormErrors.tax_rate && "border-destructive")}>
          ...
          {productFormErrors.tax_rate ? <p className="text-destructive text-xs">{productFormErrors.tax_rate}</p> : null}
        </div>
      ) : null}

      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        <div className="space-y-1.5">
          <Label htmlFor="product-variant-sku" className="text-muted-foreground text-xs font-medium">Variant SKU</Label>
          <Input
        ...
        <div className="space-y-1.5">
          <Label htmlFor="product-variant-name" className="text-muted-foreground text-xs font-medium">Variant Name</Label>
          <Input
      ...
      <div className="space-y-1.5">
        <Label htmlFor="product-desc" className="text-muted-foreground text-xs font-medium">Description</Label>
        <Textarea
          id="product-desc"
      ...
      <div className="grid grid-cols-1 gap-2 sm:grid-cols-3">
        <div className="flex items-center justify-between rounded-lg border p-3">
          ...
          <Switch checked={productForm.is_active} onCheckedChange={(checked) => setProductForm((f) => ({ ...f, is_active: checked }))} />
        </div>
        <div className="flex items-center justify-between rounded-lg border p-3">
          <div>
          ...
          <Switch
            ...
            onCheckedChange={(checked) =>
              setProductForm((f) => ({
                ...f,
                is_taxable: checked,
                tax_rate: checked ? f.tax_rate : null,
              }))
            }
          />
        </div>
        <div className="flex items-center justify-between rounded-lg border p-3">
          ...
          <Switch checked={productForm.is_serialized} onCheckedChange={(checked) => setProductForm((f) => ({ ...f, is_serialized: checked }))} />
        </div>
      </div>

      {productServerError ? (
        <div className="bg-destructive/10 text-destructive rounded-lg p-3 text-sm">{productServerError}</div>
      ) : null}
    </div>
  );
}
